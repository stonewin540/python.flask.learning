...
from flask import Flask, url_for, request, render_template, make_response, redirect, session, escape
import os
...
app.logger.debug('secret_key:', secret_key)
# app.logger.warning('type of secret_key:', type(secret_key))
# app.logger.error('Just a joke~~')
